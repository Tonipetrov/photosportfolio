			...
			initMobile: function() {
					...
					if (_.settings.autoStyleMobile) {
						...
						// Items.
							...
							_.objects.items.filter('.thumb')
								.css('margin-top', (-1 * Math.ceil(_.settings.padding / 1.4)) + 'px')
								.filter(':nth-child(2n)')
									.css('border-right', 0);
				...
				// Items.
					_.objects.items.each(function() {
						...
						var $item = $(this), $img = $item.find('img'), $header = $('#header');
						...
						$header
							.css('background-image', 'url("file:///C:/Users/tpet/Desktop/portfolio/portfolio/images/html5up-parallelism/images/thumbs/photographer.jpg")')
